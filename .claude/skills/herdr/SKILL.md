...
metadata:
  source: "verbatim output of `herdr --skill`, captured from the installed binary — not hand-written"
  captured_from_herdr_version: "0.8.2"
  refresh: "regenerate with .claude/skills/herdr/regenerate.sh after any Herdr upgrade; this file carries no self-updating version check"
---
